...
$$ \label{eq: transfer equation} x_i[k+1] = \text{cos}^2\left(f_i[k] + \zeta_i[k] - \frac{\pi}{4}\right) - \frac{1}{2} $$

$$ \label{eq: feedback term} f_i[k] = \alpha x_i[k] + \beta \sum_j J_{i,j} x_j[k] $$
